...
-   链接到SVN服务器端  
    ![](assets/svn使用详解-1.png)

-   拉取服务端数据到本地  
    ![](assets/svn使用详解-2.png)  
    注意：Checkout只在第一次链接时操作一次，以后如果进行更新操作请使用Update（更新指令）

## （Commit）提交操作

将本地修改的代码提交到远程  
![](assets/svn使用详解-3.png)  
![](assets/svn使用详解-4.png)  
![](assets/svn使用详解-5.png)

## （Update更新操作）

将远程修改的代码更新到本地  
![](assets/svn使用详解-6.png)
...
1.  忽略某个指定的文件  
    ![](assets/svn使用详解-7.png)

2.  忽略某类型文件  
    ![](assets/svn使用详解-8.png)
...
1.  在项目空白处鼠标右键，采用如下图所示操作  
    ![](assets/svn使用详解-9.png)

2.  根据日志或者版本号进行版本回退  
    ![](assets/svn使用详解-10.png)

3.  根据日志信息选择要回退的状态，点击确定即可  
    ![](assets/svn使用详解-11.png)
...
![](assets/svn使用详解-12.png)

### 解决方案

1.  update远程代码到本地  
    ![](assets/svn使用详解-13.png)
