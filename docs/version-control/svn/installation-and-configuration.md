...
![](assets/svn安装及配置-5.png)  
更改第 19 行代码，去除前面的空格以及#号，更改其值为 write（可读写）  
![](assets/svn安装及配置-6.png)

#### 账号权限控制

1.  关闭匿名用户权限控制 `svnserve.conf`文件  
    ![](assets/svn安装及配置-7.png)

2.  开启 `authz`文件和`passwd`文件  
    ![](assets/svn安装及配置-8.png)

3.  编写`passwd`文件相关用户名与密码  
    ![](assets/svn安装及配置-9.png)

4.  编写`authz`授权文件

-   设置 groups 组  
    ![](assets/svn安装及配置-10.png)

-   给 groups 设置权限  
    ![](assets/svn安装及配置-11.png)

> 组中如有多个用户用逗号分开，如：admin = admin,rootr：可读w：可写\*：其他所有用户

5.  配置成功后重新拉取或提交文件需要用户登录  
    ![](assets/svn安装及配置-12.png)
...
![](assets/svn安装及配置-13.png)  
![](assets/svn安装及配置-14.png)  
svn://SVN 服务器地址  Shop 项目（仓库）  
![](assets/svn安装及配置-15.png)  
检出成功之后该目录下会多出一个.svn 隐藏文件，代表检出成功  
![](assets/svn安装及配置-16.png)