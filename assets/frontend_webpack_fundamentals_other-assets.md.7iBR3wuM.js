...
<span class="line"><span>      },</span></span>
<span class="line"><span>      {</span></span>
<span class="line"><span>        test: /\\.(ttf|woff2?|map4|map3|avi)$/,</span></span>
...
<span class="line"><span>};</span></span></code></pre></div><p>就是在处理字体图标资源基础上增加其他文件类型，统一处理即可</p><h2 id="_2-运行指令" tabindex="-1">2. 运行指令 <a class="header-anchor" href="#_2-运行指令" aria-label="Permalink to “2. 运行指令”">​</a></h2><div class="language-plain"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>npx webpack</span></span></code></pre></div><p>打开 index.html 页面查看效果</p>`,8)]])}var s=r(a,[[`render`,o]]);export{i as __pageData,s as default};